...
export default function TaskGarden() {
  ...
  useEffect(() => {
    try {
      ...
      if (rawTasks) {
        ...
        if (Array.isArray(parsed)) setTasks(parsed.filter((t) => typeof t === "string"));
      }
    } catch {}
  ...
  useEffect(() => {
    ...
    const daysWithSessions = new Set(sessions.map((s) => s.endedAt.slice(0, 10)));
    let streak = 0;
          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span
                ...
                title={lastGrownStage === null ? "Soil" : `Stage ${lastGrownStage + 1}`}
              >
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="h-3 rounded-lg border border-neutral-700">
                <div className="h-3 rounded-lg bg-neutral-200" style={{ width: "28%" }} />
              </div>

              <p className="text-xs text-neutral-400">
                Tip: Click the dark backdrop, press <kbd>Esc</kbd>, or use Exit to leave focus mode.
              </p>
            </div>
          </div>
        </div>
